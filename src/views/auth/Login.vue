                        ...
                        <div class="vx-col sm:w-full md:w-full lg:w-1/2 mx-auto self-center d-theme-dark-bg">
                            <div class="p-8">
                                ...
                                <div v-if="notify" class="flex flex-wrap justify-between my-5">
                                  <span class="text-danger text-sm" :active="notify" v-text="messages"></span>
                                </div>

                                <!-- <vs-button  type="border">Register</vs-button> -->
                                <vs-button id="login-btn" class="float-right">Login</vs-button>
                                </form>
    ...
    methods: {
        ...
        submit() {
            ...
            this.login({
              ...
              checkbox_remember_me: this.form.checkbox_remember_me
            }).then((response) => {
              ...
              if (isEmpty(response)) {
                ...
                this.messages = response.errors.email[0]
                this.notify = true
              }
            })
        }
